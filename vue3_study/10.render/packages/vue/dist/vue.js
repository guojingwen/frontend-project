var Vue = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function createRenderer(options) {
        var _a = options, hostInsert = _a.insert, hostCreateElement = _a.createElement, hostSetElementText = _a.setElementText;
        return {
            render: render
        };
        ...
        function mountElement(vnode, container, anchor) {
            var type = vnode.type, shapeFlag = vnode.shapeFlag; vnode.props;
            // 1. 创建元素
